...
<table class="gradienttable">
  <tr>
    <td width="404" height="29" bgcolor="#339999" scope="row"><div align="left"><span class="style1">Adding Prerequisites To</span>
  ...
  <table class="gradienttable">
    ...
    <tr>
      <td height="37" bgcolor="#0066CC" scope="row"><ul class="style1">
        ...
        <ul class="style1">
          <li>
            <div align="left">Always use space  befor first AND. </div>
          </li>
        </ul>
      </td>
    </tr>
...
<table class="gradienttable">
  <tr>
    <td width="398" bgcolor="#000000" scope="row"><div align="left">
...
<form name="form1" method="post" action="">
  <table class="gradienttable">
        <tr>
          <th width="397" bgcolor="#0099FF" scope="row"><div align="left">
            <input name="button" type="button" onclick="addRow('dataTable')" value="Add Row" />
          </div></th>
        </tr>
        <tr>
          <th scope="row"><div align="left">
            <table id="dataTable" width="309" border="0">
              <tbody>
                <tr>
...
?>
  ...
  <div align="left">
	...
	<div class="alert-box success"><span>success: </span>Prerequisites has been added successfully  <a href="selectedcourses.php?id=<?php echo $curid;?>"/a>Go Back TO  Curriculum </a>
