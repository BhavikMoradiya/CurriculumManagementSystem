...
<form  id="form" name="form" method="post" action="">
  <table class="gradienttable">
    ...
    <tr>
      <th width="82" height="26" scope="row"><div align="center">Delete</div></th>
      <th width="148"><div align="center">Course Code </div></th>
      <th width="266"><div align="center">Course Name </div></th>
      <th width="249"><div align="center"><strong>Prerequisite Courses</strong></div></th>
...
?>
    <tr>
      ...
      <td><div align="center"><a href="add_prerequisites2.php?id=<?php echo $row['course_id'];?>"/a><?php echo $row["course_name"];?></div></td>
      <td><div align="center">
	   <?php
	  $cid=$row['course_id'];
