            ...
            <div align="center">
                <form id="form" name="form" method="post" action="">
                    ...
                    <table class="gradienttable">
                        ...
                        <tr>
                            <td height="27" colspan="2" bgcolor="#CCCCCC" scope="row">
                                <div align="left"><a href="forgot_password.php">Forgot You Password? </a></div>
                            </td>
                        </tr>
                        <tr>
                            <th height="27" colspan="2" bgcolor="#CCCCCC" scope="row">
                                <div align="left">
                                    <label>
                                        <input name="re" type="checkbox" id="re" value="checkbox" />
                                    </label>
                                    <span class="style2">Remember Me</span> </div>
                            </th>
                        </tr>
                        <tr>
...
?>
    ...
    ?>
                ...
                <p>
                    <a href="Hussain_almaleki.php" target="_parent"></a>
                </p>
            </div>
