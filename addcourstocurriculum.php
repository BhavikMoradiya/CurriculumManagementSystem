...
if ($result->num_rows > 0) {
    ...
    <tr>
      <th width="265" height="28" scope="row"><div align="center" class="style2">Curriculum Name </div></th>
      <td width="177"><div align="center" class="style2">Start Date </div></td>
      <td width="293"><div align="center" class="style2">End Date </div></td>
    </tr>
...
$sql = "SELECT curriculum_id, startdate, enddate FROM curriculum WHERE major_code='$code' ORDER BY startdate";
$result = $mysqli->query($sql);
...
?>	
    <tr>
      <th height="23" colspan="3" bgcolor="#009966" scope="row">&nbsp;</th>
    </tr>
  </table>
 <?php
 }
